"""The embedded single-page dashboard (HTML/CSS/JS) for `aio --web`.

Kept separate from web.py so the server logic stays readable; web.py
re-exports INDEX_HTML for backwards compatibility.
"""
